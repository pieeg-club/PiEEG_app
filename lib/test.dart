...
class ADS1299Reader {
  ...
  void _initializeADS1299() {
    ...
    _writeByte(ch1set, 0x81);
    _writeByte(ch2set, 0x81);
    _writeByte(ch3set, 0x81);
    _writeByte(ch4set, 0x81);
    _writeByte(ch5set, 0x81);
    _writeByte(ch6set, 0x81);
    _writeByte(ch7set, 0x81);
    _writeByte(ch8set, 0x81);
